...
Ng_Stateshpfile <- "C:/Users/ebamg/Urban Malaria Proj Dropbox/urban_malaria/data/nigeria/nigeria_shapefiles/Boundary_VaccStates_Export"
...
inset_map <- ggplot() +
  ...
  geom_sf(data = ng_state_shp, fill = "lightgreen") +
  #geom_sf(data = oyo_state, fill = "lightyellow", color = "black") +
  map_theme()
