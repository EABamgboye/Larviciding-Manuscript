...
jkc <- maxent(cwet_stack_r, occ_wet_sp_utm_clean, args = c("jackknife=true"))
...
ggsave(paste0(LuDataDir, '/plots/', Sys.Date(), "/", 'Jack n Knife Test for challenge.pdf'), jk_chal , width = 8, height = 11)
