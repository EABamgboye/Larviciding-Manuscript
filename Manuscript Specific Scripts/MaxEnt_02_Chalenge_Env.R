...
df_ib_c_proj <- st_transform(df_ib_c, crs(evi_stack_terrac))
...
popnd_stack_maskc <- mask(popnd_stack_cropc, ward_vectc)
...
chal_bf_stack ##From Building Morphology script
...
valsc <- values(predictors_c_subset)
