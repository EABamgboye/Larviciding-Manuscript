...
evi_dir <- "C:/Users/Dell/Urban Malaria Proj Dropbox/urban_malaria/data/nigeria/Raster_files/HLS30m/EVI/Ibadan"
...
evi_study <- evi_info %>% dplyr::filter(year == 2024, month %in% 5:7)
...
ndWi_dir<- ("C:/Users/DELL/Urban Malaria Proj Dropbox/urban_malaria/data/nigeria/Raster_files/field_study_ndwi_30m")
...
ndWi_study <- ndWi_info %>% dplyr::filter(year == 2024, month %in% 5:7)
...
ndmi_dir <- ("C:/Users/DELL/Urban Malaria Proj Dropbox/urban_malaria/data/nigeria/Raster_files/field_study_ndmi_30m")
...
# Filter to the months of interest (e.g., May–Aug 2024)
ndmi_study <- ndmi_info %>% dplyr::filter(year == 2024, month %in% 5:7)
...
ntl_rast <- rast("C:/Users/Dell/Urban Malaria Proj Dropbox/urban_malaria/data/nigeria/Raster_files/night_timel_lights/VIIRS_NTL_2024_Nigeria.tif")
...
popn_den <- rast("C:/Users/Dell/Urban Malaria Proj Dropbox/urban_malaria/data/nigeria/Raster_files/Population/NGA_pop_density/gpw_v4_population_density_rev11_2020_1_deg.tif") 
...
dwb <- rast("C:/Users/Dell/Urban Malaria Proj Dropbox/urban_malaria/data/nigeria/Raster_files/distance_to_water_bodies/distance2water_30arcsec.tif") 
...
agugu_lst <- rast("C:/Users/Dell/OneDrive - Loyola University Chicago/Documents/IB_KA_field_study-main/IB_KA_field_study-main/agugu_lstraster.tif")
...
bfp <- st_read("C:/Users/Dell/Urban Malaria Proj Dropbox/urban_malaria/data/nigeria/building_footprints/nigeria_footprints/nigeria blocks 2/Nigeria_Blocks_V1.shp")
...
predictors_a_subset <- env_stack[[vars_keep]]
...
predictors_a_subset <- rast("C:/Users/DELL/OneDrive - Loyola University Chicago/Documents/IB_KA_field_study-main/IB_KA_field_study-main/predictors_a_subset.tif")
