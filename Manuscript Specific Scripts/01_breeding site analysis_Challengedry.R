...
# Read in and prepare formal dry season from Chalomewa
...
density_summary_c <- path_summary %>%
  summarise(
    mean_density   = mean(Breeding_Site_Density),
    median_density = median(Breeding_Site_Density),
    sd_density     = sd(Breeding_Site_Density),
    UI_low         = quantile(Breeding_Site_Density, 0.025),  # 2.5th percentile
    UI_high        = quantile(Breeding_Site_Density, 0.975), # 97.5th percentile
    IQR_low        = quantile(Breeding_Site_Density, 0.25),  # Q1
    IQR_high       = quantile(Breeding_Site_Density, 0.75)   # Q3
  )
